    ...
    <div className="space-y-4">
      <div className="grid gap-3 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-6">
        ...
        <Card className="p-3">
          ...
          <p className="text-xl font-semibold">
            {stats?.leadsWithoutReply ?? 0}
          </p>
        </Card>

        <Card className="p-3">
          <p className="text-xs text-muted-foreground">Enviadas hoje</p>
          <p className="text-xl font-semibold">{stats?.sentToday ?? 0}</p>
        </Card>

        <Card className="p-3">
          <p className="text-xs text-muted-foreground">Recebidas hoje</p>
          <p className="text-xl font-semibold">{stats?.receivedToday ?? 0}</p>
        </Card>
      ...
      <div className="flex min-h-[calc(100vh-320px)] flex-col gap-4 xl:grid xl:grid-cols-[320px,minmax(0,1fr),320px]">
        <Card className="flex min-h-[280px] flex-col overflow-hidden xl:min-h-0">
          <div className="space-y-2 border-b p-3">
            ...
            <Input
              placeholder="Buscar nome, telefone, região..."
              value={query}
